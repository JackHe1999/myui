...
>
export type GetFormProviderProps<U extends {}, Value extends ObjectType> = ForceAdd<U, FormProviderProps<Value>>
...
type InputWidthFieldSet<Props extends BaseInputProps, Value> = GetFieldSetConsumerProps<AddInputProps<Props, Value>>
type InputWidthItem<Props extends BaseInputProps, Value> = GetFormItemConsumerProps<InputWidthFieldSet<Props, Value>>

type InputWidthForm<Props extends BaseInputProps, Value> = GetFormConsumerProps<InputWidthItem<Props, Value>, InputableFormConsumerKey>
// consumer
...
export type FormPropsWithProvider<Value extends ObjectType> = GetFormProviderProps<FormPropsWithCardConsumer<Value>, Value>

/**
 * @title Form
 */
export type FormProps<Value extends {}> = GetDatumFormProps<FormPropsWithProvider<Value>, Value, FormDatumKey>

export declare class Form<Value extends {}> extends React.Component<FormProps<Value>, any> {
