...
type GetAbsolutePropsIn<Props extends {}> = Omit<ForceAdd<Props, AbsoluteProps>, 'getRef'>

export type GetAbsoluteProps<Props extends {}> = GetZIndexConsumerProps<GetScrollContextConsumerValue<GetAbsolutePropsIn<Props>>>
