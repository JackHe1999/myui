...
import { Sticky } from '@mycomponents'
import locate from '@src/locate'
import Loading from '@src/Components/Loading'
import { mainClass } from '@src/styles'
...
export default function(pages) {
  function Page(props) {
    ...
    const toggleCode = () => {
      ...
      const el = document.querySelector('#-myui-menu')
    ...
    return (
      <Fragment>
        ...
        <Sticky top={0} className={mainClass('menu-sticky-wrap')}>
          <div id="-myui-menu" className={mainClass('menu', shownav && 'hidden')}>
            {pages
